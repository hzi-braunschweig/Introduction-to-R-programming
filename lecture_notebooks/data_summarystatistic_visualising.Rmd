...
consumptions of the cars in the data set, but it es not very easy to
gasp and gets very overwhelming if we want to compare different
distributions of fuel consumption (e.g. distinguished by number of
cylinders).
